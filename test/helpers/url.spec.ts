...
describe('helpers::url', () => {
  describe('buildURL', () => {
    ...
    test('should ignore if teh only param value is null', () => {
      expect(
        buildURL('/foo', {
          baz: null
        })
  ...
  describe('combineURL', () => {
    ...
    test('should not insert slashes when relative url', () => {
      expect(combineURL('https://api.github.com/users', '')).toBe('https://api.github.com/users')
    })

    test('should allow a single slashes for relative url', () => {
      expect(combineURL('https://api.github.com/users', '/')).toBe('https://api.github.com/users/')
    })
  })
  ...
  describe('isURLSameOrigin', () => {
    ...
    test('should detect different origin', () => {
      expect(isURLSameOrigin('https://githuab.com/aixos/aixos')).toBeFalsy()
    })
  })
})
